...
def single_site_graphic(X, Hexp):
    ...
    return fig, ax
#%% Figure 1
def create_figure_7(matrix, X, Hexp):
    fig, (ax1, ax2) = plt.subplots(1,2, figsize = (13,6.5))
    fig.suptitle('Figure 7: S1A Family Essential Landscape', size=24, weight='bold')
    #########################
    value = 0.0
    ...
    #########################
    rect29a = plt.Rectangle((0.5, 1.5), 2, 21, fill=False, color='tab:red', linewidth=2.0)
    rect29b = plt.Rectangle((-2.5, 1.5), 5, 2, fill=False, color='tab:red', linewidth=2.0)
    ax1.add_patch(rect29a)
    ax1.add_patch(rect29b)
    #########################
    rect38a = plt.Rectangle((8.5, 8.5), 2, 12, fill=False, color='tab:orange', linewidth=2.0)
    rect38b = plt.Rectangle((-0.5, 8.5), 11, 2, fill=False, color='tab:orange', linewidth=2.0)
...
create_figure_7(eps_data[0], X, H)
